...
test('create greeting messages for streets', () => {
    ...
    expect(messages[0]).toBe('Hellow guys from White street');
    expect(messages[1]).toBe('Hellow guys from Happy street');
    expect(messages[2]).toBe('Hellow guys from Happy street');
